...
/***/ "./src/js/modules/autoCloseModal.js":
/*!******************************************!*\
  !*** ./src/js/modules/autoCloseModal.js ***!
  \******************************************/
...
var autoCloseModal = function autoCloseModal(modalSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (autoCloseModal);
        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            if (item.getAttribute("type") === "checkbox") {
              ...
              element.forEach(function (box, i) {
                box.checked = false;
...
/* harmony import */ var _autoCloseModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./autoCloseModal */ "./src/js/modules/autoCloseModal.js");
    ...
    item.addEventListener("submit", function (event) {
      ...
      postData("assets/server.php", formData).then(function (result) {
        ...
        setTimeout(function () {
          ...
          Object(_autoCloseModal__WEBPACK_IMPORTED_MODULE_7__["default"])("[data-modal]"); // Чистим объект 
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (event) {
        ...
        if (item.classList.contains("popup_calc_button") || item.classList.contains("popup_calc_profile_button")) {
          var modalCalcFirst = document.querySelector(".popup_calc"),
              modalCalcSecond = document.querySelector(".popup_calc_profile"); // Проверяем находимся ли мы в первой модалке. Если да, то проверяем данные объекта modalState. Если ничгео не заполнено, то снова открываем только эту модалку
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener("click", function (event) {
    ...
    if (clickedPlace && (clickedPlace.classList.contains(tabSelector.replace(/\./gi, "")) || clickedPlace.parentNode.classList.contains(tabSelector.replace(/\./gi, "")))) {
